...
public class LogsController {
    ...
    public String search(@RequestParam(value = "searchFilter") String searchFilter, @RequestParam(value = "file") String filename) throws Exception {
    ...
    public void tail(@RequestParam(value = "currByte", required = false) String byteString, @RequestParam(value = "file") String filename, @RequestParam(value = "filter") String filter,
    ...
    public String export(@RequestParam(value = "searchFilter") String searchFilter, @RequestParam(value = "file") String filename) throws Exception {
