...
<link rel="stylesheet" href="../resources/codemirror/theme/night.css?version=${version}">
<link rel="stylesheet" href="../resources/codemirror/theme/monokai.css?version=${version}">
<link rel="stylesheet" href="../resources/codemirror/theme/cobalt.css?version=${version}">
<link rel="stylesheet" href="../resources/codemirror/theme/eclipse.css?version=${version}">
<link rel="stylesheet" href="../resources/codemirror/theme/lesser-dark.css?version=${version}">
<link rel="stylesheet" href="../resources/codemirror/theme/xq-dark.css?version=${version}">
<link rel="stylesheet" href="../resources/codemirror/theme/ambiance.css?version=${version}">
<link rel="stylesheet" href="../resources/codemirror/theme/blackboard.css?version=${version}">
...
<script src="../resources/codemirror/mode/css/css.js?version=${version}"></script>
<script src="../resources/codemirror/mode/htmlmixed/htmlmixed.js?version=${version}"></script>
<script src="../resources/codemirror/mode/php/php.js?version=${version}"></script>
<script src="../resources/codemirror/mode/python/python.js?version=${version}"></script>
<script src="../resources/codemirror/mode/clike/clike.js?version=${version}"></script>
...
<script src="../resources/codemirror/lib/util/match-highlighter.js?version=${version}"></script>
